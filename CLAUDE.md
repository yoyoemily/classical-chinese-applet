...
| 板块 | 关联页面 | 知识库 | 记忆文件 |
|------|---------|--------|---------|
| 学习 | index, study, word-summary, study-complete, book-select, book-detail, mistake-book, vocabulary, badges, calendar, search | `文言文/词书/readme.md` | `study/study-section.md` |
