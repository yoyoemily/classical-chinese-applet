...
const FALLBACK_CLASSICS: IClassicItem[] = [
  ...
  { id: 5,  name: '周易',       era: '商周',   icon: '☯️', description: '"群经之首"，以六十四卦推演天地消长、人事吉凶，中国哲学的源头活水。', category: '经', loadMode: 'full', navMode: 'list' },
  { id: 6,  name: '诗经',       era: '周',     icon: '🎵', description: '中国最早的诗歌总集，风、雅、颂、赋、比、兴，三百零五篇歌咏先民的悲欢与礼乐。', category: '经', loadMode: 'chunked', navMode: 'accordion' },
  { id: 7,  name: '尚书',       era: '商周',   icon: '📄', description: '上古历史文献汇编，记言体史书之祖，典、谟、训、诰、誓、命，文辞古奥。', category: '经', loadMode: 'chunked', navMode: 'list' },
  ...
  { id: 10, name: '春秋',       era: '春秋',   icon: '📋', description: '鲁国编年史，孔子笔削，微言大义。左氏、公羊、穀梁三传各阐幽微，影响深远。', category: '经', loadMode: 'full', navMode: 'list' },
  ...
  { id: 19, name: '庄子',       era: '战国',   icon: '🦋', description: '道家瑰宝，逍遥游、齐物论、养生主……汪洋恣肆的文字下，是对精神自由的极致追求。', category: '子', loadMode: 'chunked', navMode: 'list' },
  ...
  { id: 23, name: '吕氏春秋',   era: '秦',     icon: '📙', description: '吕不韦门客合著，杂家经典，一字千金典故出处，融汇诸子百家，先秦思想的集大成之作。', category: '子', loadMode: 'chunked', navMode: 'list' },
  ...
  { id: 32, name: '古文观止',   era: '清',     icon: '📖', description: '吴楚材、吴调侯编选，收录先秦至明末散文精华二百二十二篇，是古文入门的绝佳读本。', category: '集', loadMode: 'chunked', navMode: 'search' },
