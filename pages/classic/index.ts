...
const FALLBACK_CLASSICS: IClassicItem[] = [
  ...
  { id: 18, name: '老子',       era: '春秋',   icon: '🌿', description: '道家根本经典，道法自然、无为而治，五千余言说尽天地玄机与人生智慧。', category: '子', loadMode: 'full', navMode: 'list', isCompleted: 1 },
  ...
  { id: 22, name: '孙子兵法',   era: '春秋',   icon: '🗡️', description: '孙武著，兵家圣典，"不战而屈人之兵，善之善者也"，十三篇影响遍及军事与商界。', category: '子', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
  ...
  { id: 24, name: '鬼谷子',     era: '战国',   icon: '🎭', description: '纵横家经典，捭阖、反应、揣摩、权谋之术的源头。社交识人、谈判沟通——社会人士的职场智慧宝典。', category: '子', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
