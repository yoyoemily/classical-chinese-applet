...
const FALLBACK_CLASSICS: IClassicItem[] = [
  ...
  { id: 3,  name: '大学',       era: '春秋',   icon: '📘', description: '原为《礼记》篇目，讲修身、齐家、治国、平天下之道，三纲领八条目，为学次第分明。', category: '经', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
  { id: 4,  name: '中庸',       era: '春秋',   icon: '📙', description: '原为《礼记》篇目，论"中不偏，庸不易"的中庸之道，儒家哲学体系中至为精微的一篇。', category: '经', loadMode: 'full', navMode: 'list', isCompleted: 1 },
  { id: 5,  name: '周易',       era: '商周',   icon: '☯️', description: '"群经之首"，以六十四卦推演天地消长、人事吉凶，中国哲学的源头活水。', category: '经', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  ...
  { id: 38, name: '孝经',       era: '春秋',   icon: '📕', description: '十三经之一，专论孝道，仅十八章约一千八百字。"夫孝，德之本也"，儒家伦理的基石，与中学生德育高度契合。', category: '经', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
  { id: 43, name: '三字经',     era: '南宋',   icon: '📗', description: '传统蒙学第一书，三字一句、朗朗上口。"人之初，性本善"，中国学生人人会背的启蒙经典。', category: '经', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
  { id: 44, name: '千字文',     era: '南朝梁', icon: '📘', description: '一千个不重复的汉字编成二百五十句四言韵文，涵盖天文地理历史伦理，构思之精巧古今无双。', category: '经', loadMode: 'full', navMode: 'strip', isCompleted: 1 },
  ...
  { id: 17, name: '荀子',       era: '战国',   icon: '📚', description: '儒家重要一脉，主张"性恶论"与"化性起伪"，《劝学篇》为教材必背篇目，地位不亚于孟子。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  { id: 18, name: '老子',       era: '春秋',   icon: '🌿', description: '道家根本经典，道法自然、无为而治，五千余言说尽天地玄机与人生智慧。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  ...
  { id: 20, name: '韩非子',     era: '战国',   icon: '⚖️', description: '法家集大成者，以法治国、法术势结合，犀利冷峻的笔锋直指人性和权力的本质。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  { id: 21, name: '墨子',       era: '战国',   icon: '🛡️', description: '墨家经典，兼爱、非攻、尚贤、尚同，先秦最富实践精神的思想体系。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  { id: 22, name: '孙子兵法',   era: '春秋',   icon: '🗡️', description: '孙武著，兵家圣典，"不战而屈人之兵，善之善者也"，十三篇影响遍及军事与商界。', category: '子', loadMode: 'chunked', navMode: 'strip', isCompleted: 1 },
  ...
  { id: 24, name: '鬼谷子',     era: '战国',   icon: '🎭', description: '纵横家经典，捭阖、反应、揣摩、权谋之术的源头。社交识人、谈判沟通——社会人士的职场智慧宝典。', category: '子', loadMode: 'chunked', navMode: 'strip', isCompleted: 1 },
  ...
  { id: 37, name: '列子',       era: '战国',   icon: '🦅', description: '道家三经之一，名篇密度极高：愚公移山、杞人忧天、朝三暮四、夸父逐日——全是课本常客。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  { id: 40, name: '颜氏家训',   era: '北齐',   icon: '📝', description: '中国第一部系统家训，颜之推著。论学论教论处世，与"帮助中学生掌握文言文"的定位天然吻合。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  { id: 45, name: '淮南子',     era: '西汉',   icon: '🌌', description: '西汉道家集大成，刘安编著。女娲补天、后羿射日、共工怒触不周山——神话寓言的宝库。', category: '子', loadMode: 'chunked', navMode: 'list' },
  { id: 46, name: '晏子春秋',   era: '春秋',   icon: '💡', description: '晏婴故事集，"橘逾淮为枳""二桃杀三士"等名篇，篇幅短小、机智幽默，适合中学生阅读。', category: '子', loadMode: 'chunked', navMode: 'list' },
  { id: 47, name: '菜根谭',     era: '明',     icon: '🥬', description: '洪应明著格言体小品，一句话一条，极短极精。"咬得菜根，百事可做"，适合碎片化阅读。', category: '子', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  ...
  { id: 33, name: '世说新语',   era: '南朝宋', icon: '💬', description: '刘义庆编，魏晋名士的言行轶事集，一部"名士教科书"，风度与智慧，跃然纸上。', category: '集', loadMode: 'chunked', navMode: 'accordion', isCompleted: 1 },

  { id: 35, name: '聊斋志异',   era: '清',     icon: '👻', description: '蒲松龄著，"刺贪刺虐入木三分"，花妖狐媚、鬼怪神异，文言短篇小说的巅峰。', category: '集', loadMode: 'chunked', navMode: 'list' },
  { id: 36, name: '山海经',     era: '战国至汉', icon: '🐉', description: '上古奇书，山川地理与神话传说交织，夸父逐日、精卫填海、大禹治水……想象力无远弗届。', category: '集', loadMode: 'chunked', navMode: 'accordion', isCompleted: 1 },
  ...
  { id: 48, name: '西厢记',     era: '元',     icon: '💕', description: '王实甫著，元杂剧巅峰。张生与崔莺莺的爱情故事，"愿天下有情人终成眷属"，句句锦绣。', category: '集', loadMode: 'chunked', navMode: 'accordion', isCompleted: 1 },
  { id: 49, name: '牡丹亭',     era: '明',     icon: '🪷', description: '汤显祖著，明传奇最高成就。杜丽娘因情而死、因情而生，"情不知所起，一往而深"。', category: '集', loadMode: 'chunked', navMode: 'accordion' },

  { id: 55, name: '浮生六记',   era: '清',     icon: '🌸', description: '沈复自传体散文，记闺房之乐、闲情之趣、坎坷之愁、浪游之快。语言洗练真挚，古文过渡阅读的绝佳之选。', category: '集', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
  ...
  { id: 57, name: '陶渊明集',   era: '东晋',   icon: '🌾', description: '"归去来兮，田园将芜胡不归"——中国隐逸诗人之宗。读陶渊明，读的是每个人心中"我想回去"的最早版本。', category: '集', loadMode: 'chunked', navMode: 'list', isCompleted: 1 },
