    ...
    words: [
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '连词', definition: '表示并列关系，可译为"和""又""并且"', pinyin: 'ér', example: '敏而好学，不耻下问。', translation: '聪敏并且爱好学习，不以向不如自己的人请教为耻。', source: '《论语·公冶长》' },
          { partOfSpeech: '连词', definition: '表示转折关系，可译为"却""但是""然而"', pinyin: 'ér', example: '学而不思则罔，思而不学则殆。', translation: '只学习而不思考就会迷惑，只思考而不学习就会疑惑。', source: '《论语·为政》' },
          { partOfSpeech: '连词', definition: '表示承接关系，可译为"就""然后""接着"', pinyin: 'ér', example: '温故而知新，可以为师矣。', translation: '温习旧的知识，进而能有新的体会，就可以做老师了。', source: '《论语·为政》' },
          { partOfSpeech: '连词', definition: '表示修饰关系，连接状语和中心语，可译为"地""着"或不译', pinyin: 'ér', example: '河曲智叟笑而止之曰。', translation: '河曲智叟笑着阻止他说。', source: '《愚公移山》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '代词', definition: '作第三人称代词，可译为"他/她/它"或"他们"', pinyin: 'zhī', example: '学而时习之，不亦说乎？', translation: '学习了然后按时温习它，不也很愉快吗？', source: '《论语·学而》' },
          { partOfSpeech: '助词', definition: '结构助词，用在定语和中心语之间，相当于"的"', pinyin: 'zhī', example: '此诚危急存亡之秋也。', translation: '这确实是危急存亡的时刻啊。', source: '《出师表》' },
          { partOfSpeech: '助词', definition: '用在主谓之间，取消句子独立性，不译', pinyin: 'zhī', example: '予独爱莲之出淤泥而不染。', translation: '我唯独喜爱莲花从淤泥中长出却不被污染。', source: '《爱莲说》' },
          { partOfSpeech: '动词', definition: '到，往，去', pinyin: 'zhī', example: '辍耕之垄上。', translation: '停止耕作走到田垄上。', source: '《陈涉世家》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '介词', definition: '用，拿，把，凭借', pinyin: 'yǐ', example: '以刀劈狼首。', translation: '用刀劈砍狼的头。', source: '《狼》' },
          { partOfSpeech: '介词', definition: '因为，由于', pinyin: 'yǐ', example: '不以物喜，不以己悲。', translation: '不因为外物的好坏而高兴，不因为自己的得失而悲伤。', source: '《岳阳楼记》' },
          { partOfSpeech: '连词', definition: '表示目的，可译为"来""用来""以便"', pinyin: 'yǐ', example: '属予作文以记之。', translation: '嘱托我写一篇文章来记述这件事。', source: '《岳阳楼记》' },
          { partOfSpeech: '动词', definition: '认为，以为', pinyin: 'yǐ', example: '皆以美于徐公。', translation: '都认为比徐公美。', source: '《邹忌讽齐王纳谏》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '介词', definition: '在，到，从，对，向（引出时间、地点、对象）', pinyin: 'yú', example: '战于长勺。', translation: '在长勺作战。', source: '《曹刿论战》' },
          { partOfSpeech: '介词', definition: '表示比较，相当于"比"', pinyin: 'yú', example: '皆以美于徐公。', translation: '都认为比徐公美。', source: '《邹忌讽齐王纳谏》' },
          { partOfSpeech: '介词', definition: '表示被动，相当于"被"', pinyin: 'yú', example: '吾长见笑于大方之家。', translation: '我长久地被大方之家所耻笑。', source: '《庄子·秋水》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '动词', definition: '做，干，成为，当作', pinyin: 'wéi', example: '温故而知新，可以为师矣。', translation: '温习旧知识进而能有新体会，就可以做老师了。', source: '《论语·为政》' },
          { partOfSpeech: '介词', definition: '替，给，为了', pinyin: 'wèi', example: '为人谋而不忠乎？', translation: '替别人办事是不是尽心竭力了呢？', source: '《论语·学而》' },
          { partOfSpeech: '介词', definition: '被', pinyin: 'wéi', example: '茅屋为秋风所破歌。', translation: '茅屋被秋风吹破所作之歌。', source: '杜甫《茅屋为秋风所破歌》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '副词', definition: '于是，就，这才', pinyin: 'nǎi', example: '乃悟前狼假寐，盖以诱敌。', translation: '这才明白前面那只狼假装睡觉，原来是为了引诱敌人。', source: '《狼》' },
          { partOfSpeech: '副词', definition: '竟然，却（表示出乎意料）', pinyin: 'nǎi', example: '问今是何世，乃不知有汉，无论魏晋。', translation: '问现在是什么朝代，竟然不知道有汉朝，更不用说魏晋了。', source: '《桃花源记》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '连词', definition: '所以，因此', pinyin: 'gù', example: '故天将降大任于是人也，必先苦其心志。', translation: '所以上天将要下达重大使命给这个人，一定要先使他的心志痛苦。', source: '《生于忧患，死于安乐》' },
          { partOfSpeech: '名词', definition: '原因，缘故', pinyin: 'gù', example: '公问其故。', translation: '庄公问其中原因。', source: '《曹刿论战》' },
          { partOfSpeech: '形容词', definition: '旧的，原来的，从前的', pinyin: 'gù', example: '温故而知新。', translation: '温习旧的知识，进而能有新的体会。', source: '《论语·为政》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '副词', definition: '将要，将近', pinyin: 'qiě', example: '北山愚公者，年且九十。', translation: '北山有个叫愚公的人，年纪将近九十岁了。', source: '《愚公移山》' },
          { partOfSpeech: '连词', definition: '并且，而且，况且（表示递进）', pinyin: 'qiě', example: '且焉置土石？', translation: '况且把土石放到哪里去呢？', source: '《愚公移山》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '连词', definition: '就，便（表示承接）', pinyin: 'zé', example: '学而不思则罔。', translation: '只学习而不思考就会迷惑。', source: '《论语·为政》' },
          { partOfSpeech: '连词', definition: '如果（表示假设）', pinyin: 'zé', example: '入则无法家拂士，出则无敌国外患者，国恒亡。', translation: '如果在国内没有守法度的大臣，在国外没有敌对的国家，国家常常会灭亡。', source: '《生于忧患，死于安乐》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '连词', definition: '即使，纵使（表示假设让步）', pinyin: 'suī', example: '虽我之死，有子存焉。', translation: '即使我死了，还有儿子在呀。', source: '《愚公移山》' },
          { partOfSpeech: '连词', definition: '虽然（表示转折）', pinyin: 'suī', example: '故余虽愚，卒获有所闻。', translation: '所以我虽然愚笨，但最终还是获得了一些学识。', source: '《送东阳马生序》' },
        ],
        sentences: [
    ...
    words: [
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '动词', definition: '说话，讲述，说明', pinyin: 'shuō', example: '及郡下，诣太守，说如此。', translation: '到了郡城，去拜见太守，讲述了这些经历。', source: '《桃花源记》' },
          { partOfSpeech: '通假字', definition: '通"悦"，高兴，愉快', pinyin: 'yuè', example: '学而时习之，不亦说乎？', translation: '学习了然后按时温习它，不也很愉快吗？', source: '《论语·学而》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '形容词', definition: '相反的，对立的', pinyin: 'fǎn', example: '知其一，不知其反。', translation: '知道其中一面，不知道反面。', source: '' },
          { partOfSpeech: '通假字', definition: '通"返"，返回，归来', pinyin: 'fǎn', example: '寒暑易节，始一反焉。', translation: '冬夏换季的时候，才回家一次。', source: '《愚公移山》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '动词', definition: '看见，看到', pinyin: 'jiàn', example: '见渔人，乃大惊。', translation: '（桃花源中人）看见渔人，于是非常惊讶。', source: '《桃花源记》' },
          { partOfSpeech: '通假字', definition: '通"现"，显现，出现，表现', pinyin: 'xiàn', example: '风吹草低见牛羊。', translation: '风吹过，草低下去，显露出牛羊来。', source: '《敕勒歌》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '介词', definition: '表示被动', pinyin: 'bèi', example: '信而见疑，忠而被谤。', translation: '诚信却被怀疑，忠诚却被诽谤。', source: '《史记·屈原列传》' },
          { partOfSpeech: '通假字', definition: '通"披"，穿，披着', pinyin: 'pī', example: '将军身被坚执锐。', translation: '将军亲自穿着坚固的盔甲，拿着锐利的武器。', source: '《陈涉世家》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '动词', definition: '隶属，归属，属于', pinyin: 'shǔ', example: '有良田美池桑竹之属。', translation: '有肥沃的田地、美丽的池塘以及桑树竹子之类。', source: '《桃花源记》' },
          { partOfSpeech: '通假字', definition: '通"嘱"，嘱托，托付', pinyin: 'zhǔ', example: '属予作文以记之。', translation: '嘱托我写一篇文章来记述这件事。', source: '《岳阳楼记》' },
        ],
        sentences: [
      ...
      },
      {
        ...
        ancientForm: 'https://placehold.co/400x400/c9a96e/fff?text=Ancient',
        meanings: [
          { partOfSpeech: '副词', definition: '曾经', pinyin: 'céng', example: '曾是以为孝乎？', translation: '曾经以为这就是孝吗？', source: '《论语·为政》' },
          { partOfSpeech: '通假字', definition: '通"层"，重叠', pinyin: 'céng', example: '荡胸生曾云，决眦入归鸟。', translation: '层层云气在胸中激荡，睁大眼睛目送归鸟入山。', source: '杜甫《望岳》' },
        ],
        sentences: [
