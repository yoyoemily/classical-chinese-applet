...
标准来自知识库 `文言文/选篇/典故注释/readme.md`，以下是标注范围：
...
| 器物、草木、动物 | 虚词——词书已覆盖 |
| 官职、制度 | 代词——词书已覆盖 |
| 文化隐喻、典故、成语出处 | 常见名词（春年山日）——现代汉语常用 |
| 名句、哲理表达 | 现代汉语极度常见的词（的、了、是、我、你、他…） |
| keyWord 误标移入的条目 | 学生 100% 确定的词 |
...
```bash
# 正文（含 keyWords）—— 全量导入（拼接 11 个年级分文件 + 1 个壳文章文件后发送）
