...
- [🔍 选篇 keyWords 词书交叉核对](keywords-audit-master-plan.md) — 系统性质量排查：2030 条 keyWords 分 12 批逐一核对 8 本打卡型词书（虚词解析不参与），修正/删除不在词书范围内的标注。待启动。触发词：继续核对 keyWords、继续选篇字词标注排查、继续第 N 批
