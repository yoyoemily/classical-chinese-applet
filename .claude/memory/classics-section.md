...
|------|----|----------|---------|------|
| 孙子兵法 | 22 | full | strip | 13 篇短文，横向滑选 |
| 老子 | 18 | full | list | 81 章极短，全量竖排 |
...
| 18 | 老子 | 子 | 章节型 | full | list | 81 章 ✅ |
| 19 | 庄子 | 子 | 章节型 | chunked | accordion | 33 篇，内篇/外篇/杂篇三分 |
| 20 | 韩非子 | 子 | 章节型 | chunked | list | 55 篇 |
| 21 | 墨子 | 子 | 章节型 | chunked | list | 53 篇 |
| 22 | 孙子兵法 | 子 | 章节型 | full | strip | 13 篇 ✅ |
| 23 | 吕氏春秋 | 子 | 章节型 | chunked | accordion | 12 纪/8 览/6 论 |
| 24 | 鬼谷子 | 子 | 章节型 | full | strip | 14 篇，极短 |
| 26 | 黄帝内经 | 子 | 章节型 | chunked | accordion | 素问/灵枢两部 |
...
| 27 | 楚辞 | 集 | 选集型 | full | strip | 篇幅短小，篇目少 |
| 28 | 唐诗三百首 | 集 | 选集型 | chunked | author | 311 首 74 位作者 ✅ |
| 29 | 宋词三百首 | 集 | 选集型 | chunked | author | ~300 首，按作者浏览 |
| 30 | 乐府诗集 | 集 | 选集型 | chunked | accordion | 按曲调/题材分组 |
| 31 | 全唐诗 | 集 | 选集型 | chunked | author | 48,000+ 首，按作者浏览 |
| 32 | 古文观止 | 集 | 选集型 | chunked | author | 222 篇，按作者/朝代浏览 |
| 33 | 世说新语 | 集 | 选集型 | chunked | accordion | 36 门 ✅ |
| 34 | 梦溪笔谈 | 集 | 选集型 | chunked | accordion | 按门类分组 |
| 35 | 聊斋志异 | 集 | 选集型 | chunked | list | 491 篇独立故事，按篇名浏览 |
| 36 | 山海经 | 集 | 卷帙型 | chunked | accordion | 18 卷 ✅ (首批 4 卷) |
...
| 50 | 文心雕龙 | 集 | 章节型 | chunked | list | 50 篇，骈文典范 |
...
**已上线 11 部，剩余 41 部完全空白**（无 JSON 数据、未导入、前端不可用）。上方的 loadMode/navMode 分配表仅为规划，不表示任何进度。

| 经典 | id | 类型 | navMode | 规模 | 状态 |
|------|----|------|---------|------|------|
| 孙子兵法 | 22 | 章节型 | strip | 13 篇，78 段落，181 条注释 | ✅ 已上线 |
| 老子 | 18 | 章节型 | list | 81 章，289 条注释，6410 字 | ✅ 已上线 |
| 世说新语 | 33 | 选集型 | accordion | 21 门，106 条注释 | ✅ 已上线 |
| 山海经 | 36 | 卷帙型 | accordion | 18 卷（山经5卷+海经8卷+大荒经4卷+海内经1卷），50 条注释 | ✅ 已上线 |
| 唐诗三百首 | 28 | 选集型 | author | 293 首，687 条注释，293 条创作背景 | ✅ 已上线 |
