...
### 内容完整性（2026-07-21 数据库快照）

25 部已上线经典中，13 部基本完整，12 部有不同程度的内容缺失：

**✅ 基本完整（13 部）**：宋词三百首、老子、周易、中庸、孙子兵法、唐诗三百首、三字经、孝经、千字文、围炉夜话、大学、菜根谭、鬼谷子

**⚠️ 内容偏薄但目录全（4 部）**：楚辞（~15%缺）、列子（~75%缺）、晏子春秋（~80%缺）、颜氏家训（~70%缺）——TOC 结构完整，但每篇只写了骨架文本

**❌ 严重残缺（6 部）**：荀子（~93%缺段落）、韩非子（~98%缺 39 章+内容）、墨子（~98%缺 45 章+内容）、世说新语（~97%缺条目）、山海经（~60%缺段落）、西厢记（~97%缺）、浮生六记（~80%缺）、陶渊明集（~80%缺，仅选 15 首）

**❌ 空壳（2 部）**：淮南子、韩愈文集——元数据有但章节表完全为空，前端可点击但会白屏

**修复优先级**：淮南子/韩愈文集（下线或导入骨架）→ 西厢记/韩非子/墨子（名篇优先补全）→ 世说新语（1100+条目分批导入）→ 荀子（目录全，补段落即可，体量小）
