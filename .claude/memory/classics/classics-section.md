...
**推荐使用独立 glossary.json 文件**（自 2026-07-25 起支持）。典故注释与正文完全解耦，支持先导入正文、后补注释的两步工作流。
...
**2026-07-26：全部典故注释已清空。** 当前阶段聚焦经典原文和译文的编撰与导入，典故注释延后到全部经典上线后再统一铺排。glossary.json 文件暂时保留在知识库中（作为独立文件），但暂不导入数据库。
...
> **当前策略**：聚焦经典原文和译文的编撰与导入，典故注释（glossary）延后到全部经典上线后再统一铺排。所有已上线经典的 glossary 已于 2026-07-26 清空。
...
**⚠️ 内容偏薄但目录全（0 部）**：无——2026-07-26 完成楚辞/列子/颜氏家训/晏子春秋 4 部文本编撰，全部转入基本完整
